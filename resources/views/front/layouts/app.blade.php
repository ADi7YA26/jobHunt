		...
		<footer class="footer container-fluid mt-5 border-top">
			<div class="row py-5 my-5 ">
				...
				<div class="col">
					...
					<ul class="nav flex-column gap-3">
						<li><a href="tel:+91913403506"> <i class="bi bi-telephone-fill"></i> +91 913403506 </a></li>
						<li><a href=""> <i class="bi bi-geo-alt-fill"></i> 123 Main Street, Anytown, Hindustan </a></li>
					</ul>
				</div>
			</div>
